...
Public Class CodeGenerator
    ...
    ''' DTO クラスコードを生成する
    ''' </summary>
    Public Function GenerateDto(namespaceName As String,
...
"''' </summary>" & vbCrLf &
"Public Class {ClassName}Dto" & vbCrLf & vbCrLf &
"{Properties}" & vbCrLf &
...
"''' {TableDescription}" & vbCrLf &
"''' </summary>" & vbCrLf &
"Public Class {ClassName}Model" & vbCrLf & vbCrLf &
"{Properties}" & vbCrLf &
"    ''' <summary>" & vbCrLf &
...
"    ''' </summary>" & vbCrLf &
"    Public Shared Function FromDto(source As {ClassName}Dto) As {ClassName}Model" & vbCrLf &
