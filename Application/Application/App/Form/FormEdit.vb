Public Class FormEdit
    ...
    Private ReadOnly _service As New LectureActualService()
    ...
    Private Sub BtnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Try
            Dim entity As New LectureActualEntity
    ...
    Private Sub BtnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            Dim entityBefore As New LectureActualEntity
            ...
            Dim entityAfter As New LectureActualEntity
            entityAfter.ID = "6"
